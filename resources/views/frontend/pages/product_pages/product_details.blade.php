                        ...
                        <div class="thumbs-slider">
                            <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                <div class="swiper-wrapper stagger-wrap">
                                    ...
                                    <div class="swiper-slide stagger-item" data-color="gray">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-5.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-5.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide stagger-item" data-color="beige">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-6.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-6.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide stagger-item" data-color="beige">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-7.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-7.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide stagger-item" data-color="beige">
                                        <div class="item">
                                    ...
                                    <div class="swiper-slide stagger-item" data-color="grey">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-23.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-23.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide stagger-item" data-color="grey">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-24.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-24.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-color="gray">
                                        <a href="{{ asset('images/products/womens/women-3.jpg') }}" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-3.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-3.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-3.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="gray">
                                        <a href="{{ asset('images/products/womens/women-1.jpg') }}" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="gray">
                                        <a href="{{ asset('images/products/womens/women-2.jpg') }}" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="gray">
                                        <a href="images/products/womens/women-5.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-5.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-5.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-5.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="beige">
                                        <a href="images/products/womens/women-6.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-6.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-6.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-6.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="beige">
                                        <a href="images/products/womens/women-7.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-7.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-7.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-7.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="beige">
                                        <a href="images/products/womens/women-7.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                    ...
                                    <div class="swiper-slide" data-color="grey">
                                        <a href="images/products/womens/women-23.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-23.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-23.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-23.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide" data-color="grey">
                                        <a href="images/products/womens/women-24.jpg" target="_blank" class="item" data-pswp-width="600px" data-pswp-height="800px">
                                            <img class="tf-image-zoom lazyload" data-zoom="{{ asset('public/frontend/images/products/womens/women-24.jpg') }}" data-src="{{ asset('public/frontend/images/products/womens/women-24.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-24.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form class="form-bundle-product type-cols">
                                ...
                                <div class="tf-bundle-products-wrap">
                                    <div class="tf-bundle-product-item">
                                        <input class="tf-check" type="checkbox" checked="checked">
                                        <div class="tf-product-bundle-image">
                                            <a href="#">
                                                <img src="{{ asset('public/frontend/images/products/womens/women-19.jpg') }}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="tf-bundle-product-item">
                                        ...
                                        <div class="tf-product-bundle-image">
                                            <a href="#">
                                                <img src="{{ asset('public/frontend/images/products/womens/women-37.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="tf-product-bundle-infos">
                                    ...
                                    <div class="tf-bundle-product-item">
                                        <input class="tf-check" type="checkbox">
                                        <div class="tf-product-bundle-image">
                                            <a href="#">
                                                <img src="{{ asset('public/frontend/images/products/womens/women-29.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="tf-product-bundle-infos">
                        ...
                        <div class="widget-content-inner">
                            <div class="tab-shipping">
                                ...
                                <div class="w-100">
                                    ...
                                    <p>Let us handle the legwork. Delivery duties are included in the item price when shipping to all EU countries (excluding the Canary Islands), plus The United Kingdom, USA, Canada, China Mainland, Australia, New
                                        Zealand, Puerto Rico, Switzerland, Singapore, Republic Of Korea, Kuwait, Mexico, Qatar, India, Norway, Saudi Arabia, Taiwan Region, Thailand, U.A.E., Japan, Brazil, Isle of Man, San Marino, Colombia, Chile,
                                        Argentina, Egypt, Lebanon, Hong Kong SAR, Bahrain and Turkey. All import duties are included in your order – the price you see is the price you pay.</p>
                                </div>
                                <div class="w-100">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card-product">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('public/frontend/images/products/womens/women-176.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-176.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('public/frontend/images/products/womens/women-179.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-179.jpg') }}" alt="image-product">
                                    </a>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active line">
                                            ...
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-176.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-176.jpg') }}" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="swatch-value bg-light-blue-2"></span>
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-177.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-177.jpg') }}" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product card-product-size">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('public/frontend/images/products/womens/women-29.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-29.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('public/frontend/images/products/womens/women-30.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-30.jpg') }}" alt="image-product">
                                    </a>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active line">
                                            ...
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-29.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-29.jpg') }}" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="swatch-value bg-light-grey"></span>
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-33.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-33.jpg') }}" alt="image-product">
                                        </li>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="list-product-btn">
                                        <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                            <span class="icon icon-heart"></span>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active line">
                                            ...
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-1.jpg') }}" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="swatch-value bg-light-pink"></span>
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-2.jpg') }}" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="swatch-value bg-dark-grey-2"></span>
                                            <img class="lazyload" data-src="{{ asset('public/frontend/images/products/womens/women-3.jpg') }}" src="{{ asset('public/frontend/images/products/womens/women-3.jpg') }}" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
