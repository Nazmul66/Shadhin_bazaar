        ...
        <ul>
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('public/frontend/images/tab_2.jpg') }}" alt="product" class="img-fluid w-100"></a>
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('public/frontend/images/pro4.jpg') }}" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('public/frontend/images/pro2.jpg') }}" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('public/frontend/images/pro9.jpg') }}" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
