            ...
            <form method="POST" action="{{ route('admin.role.store') }}" enctype="multipart/form-data">
                ...
                <div class="row align-items-center mb-5">
                    <div class="col-lg-6 mb-3">
                        <input type="text" class="form-control" placeholder="Create Role....." required name="name" >
                    </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-9 offset-1">
                                        <div class="d-flex align-items-center border-bottom py-2">
                                            <input class="form-check-input m-0" type="checkbox" name="permission[]" value="{{ $permission->name }}">
